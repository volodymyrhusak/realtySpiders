...
class FrenkenhomesSpider(CrawlSpider):
    ...
    def parseItem(self, response):
        ...
        l.add_xpath('Lot_BlockWidth', '//*[@id="details"]/tr/th[text()="Land Area"]/following-sibling::td/text()')
        l.add_xpath('HomeDesignMainImage', '//li[@id="img1"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('FloorPlanImage1',
                    '//div[@class="property-details-buttons"]/a/span[text()="Floor Plan"]/ancestor::a/@href',
                    **{'myRefer': referer})
        l.add_xpath('Image1', '//li[@id="img1"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image2', '//li[@id="img2"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image3', '//li[@id="img3"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image4', '//li[@id="img4"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image5', '//li[@id="img5"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image6', '//li[@id="img6"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image7', '//li[@id="img7"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image8', '//li[@id="img8"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image9', '//li[@id="img9"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image10', '//li[@id="img10"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image11', '//li[@id="img11"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image12', '//li[@id="img12"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image13', '//li[@id="img13"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image14', '//li[@id="img14"]/a/img/@src', **{'myRefer': referer})
        l.add_xpath('Image15', '//li[@id="img15"]/a/img/@src', **{'myRefer': referer})
